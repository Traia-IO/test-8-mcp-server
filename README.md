...
This is an MCP (Model Context Protocol) server that provides access to the test 8 API. It enables AI agents and LLMs to interact with test 8 through standardized tools.

## Features

- 🔧 **MCP Protocol**: Built on the Model Context Protocol for seamless AI integration
- 🌐 **Full API Access**: Provides tools for interacting with test 8 endpoints
- 🐳 **Docker Support**: Easy deployment with Docker and Docker Compose
- ⚡ **Async Operations**: Built with FastMCP for efficient async handling

## API Documentation

- **test 8 Website**: [https://petstore.swagger.io/](https://petstore.swagger.io/)
- **API Documentation**: []()
...
*Note: Replace `example_tool` with actual test 8 API tools based on the documentation.*
...
1. Clone this repository:
   ```bash
   git clone https://github.com/Traia-IO/test-8-mcp-server.git
   cd test-8-mcp-server
   ```
...
1. Create API client functions for test 8 endpoints
...
```json
{
  "github_url": "https://github.com/Traia-IO/test-8-mcp-server",
  "mcp_server": {
    "name": "test-8-mcp",
    "description": "Handleretryh andleretryhandler etryhandleretryhandleretry ",
